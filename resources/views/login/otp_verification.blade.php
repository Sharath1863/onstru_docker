        ...
        <div class="login-div">
            ...
            <div class="login-right mx-auto">
                ...
                <div class="login-form">
                    <form action="{{ route('login.new-password') }}" method="POST">
                        @csrf
                        <div class="row">
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            if (response.status === 'success') {
                                window.location.href = "{{ route('login.new-password-view') }}";
                            } else {
        ...
        $("#resendOtpBtn").on("click", function (e) {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    setTimeout(() => {
                        $("#resendOtpBtn").prop("disabled", false).css({
                            "pointer-events": "auto",
                            "opacity": "1"
                        });
                    }, 120000);
