...
<head>
    ...
    <title>Onstru | Chatbot Report</title>
        ...
        <div class="body-main">
            ...
            <div class="main-div px-4 py-1">
                <div class="body-head mb-3">
                    <h4 class="m-0">Chatbot Report</h4>
                </div>
                                    ...
                                    <tbody>
                                        @foreach ($chatbots as $chatbot)
                                            <tr id="{{ $chatbot->id }}">
                                                ...
                                                <td>{{ $chatbot->user->user_name ?? '-'}}</td>
                                                <td>{{ $chatbot->user->as_a ?? 'Consumer' }}</td>
                                                <td>₹ {{ $chatbot->amount ?? '-' }}</td>
                                                <td>{{ $chatbot->created_at->format('d-m-Y') }}</td>
                                                <td>
                                                    <div class="d-flex align-items-center column-gap-2">
                                                        <a href="{{ url('user_detail', ['id' => $chatbot->created_by]) }}"
