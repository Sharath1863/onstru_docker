...
@if ($orders->filter(fn($order) => $order->products->first()?->status === 'processing' || $order->products->first()?->status == 'active')->count() === 0)
            ...
            <table class="table" id="table2">
                ...
                <tbody>
                    ...
                    @foreach ($orders as $order)
                        @if ($order->products->contains('status', 'processing') || $order->products->first()?->status == 'active')
