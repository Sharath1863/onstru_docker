<!-- Empty State -->
<div class="side-cards shadow-none border-0" style="{{ count($jobs) > 0 ? 'display: none;' : 'display: block;' }}">
    ...
    <div class="side-cards job-card mb-2 position-relative" data-category="{{ $job->categoryRelation->value }}"
        ...
        <div class="cards-head">
            ...
            @if ($job->highlighted == '1')
                <span class="badge"><img src="{{ asset('assets/images/icon_fire.png') }}" height="15px" class="pe-1" alt="">
                    Boosted</span>
            @endif
        </div>
