<div class="container-fluid px-0">
    ...
    <div class="side-cards shadow-none border-0" style="{{ count($like) > 0 ? 'display: none;' : 'display: block;' }}">
                    ...
                    @if ($post->sense == 1)
                        <div class="sensitive-overlay z-3">
                            <div class="overlay-content text-center">
                                <img src="{{ asset('assets/images/Sensitive.png') }}" height="50px" class="d-flex mx-auto mb-2"
                                    alt="">
                            </div>
                        </div>
                    @endif
